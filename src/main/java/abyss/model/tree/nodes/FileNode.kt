...
//class RootNode(
//    private val children: MutableList<MutableTreeNode>,
//    private var nodeParent: TreeNode? = null
//): NodeInterface {
//    override fun children(): Enumeration<out TreeNode> = children.toEnumeration()
//
...
//    }
//
//    override fun setParent(newParent: MutableTreeNode?) { nodeParent = newParent }
//
//    override fun getParent(): TreeNode? = nodeParent
//
//    override fun getChildAt(childIndex: Int): TreeNode? = children[childIndex]
...
//    override fun getAllowsChildren(): Boolean = true
//
//    override fun setUserObject(`object`: Any?) { assert(true) { "Not allowed." } }
//
//    override fun remove(index: Int) { children.removeAt(index) }
//
//    override fun remove(node: MutableTreeNode) { children.remove(node) }
//
//    override fun isLeaf(): Boolean = childCount == 0
//
//    override fun getChildCount(): Int = children.size
//
//    override fun removeFromParent() { nodeParent?.remove(this) }
//}
